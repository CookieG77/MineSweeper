...
FltkImage = Union[ImageTk.PhotoImage, tk.PhotoImage]
...
__img: Dict[Tuple[Path, int, int], FltkImage] = {}
...
def _load_tk_image(fichier: str,
                   hauteur: Optional[int] = None,
                   largeur: Optional[int] = None) -> FltkImage:
    chemin = Path(fichier)
    ph_image = tk.PhotoImage(file=fichier)
